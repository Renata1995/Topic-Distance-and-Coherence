...
for corpus_type in ("binary","bow","tfidf"):
    output = corpus_type+str(topics_count)
    # get tc values from topics
    tclist = []  
...
plt.legend([linelist[0], linelist[1], linelist[2],linelist2[0], linelist2[1]], \
           ["binary", "bow", "tfidf", "binary-"+str(startw), "bow-"+str(startw)],loc='lower right',bbox_to_anchor=(1,-0.1), ncol=6)

fig = plt.gcf()
fig.set_size_inches(16,12)
plt.savefig("plot_data_"+topics_count+"_"+tc+"_start"+str(startw)+".png")
